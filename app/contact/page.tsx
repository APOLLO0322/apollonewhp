        ...
        <div className="grid lg:grid-cols-[0.85fr_1.15fr]">
          <div className="flex flex-col justify-between bg-ink px-5 py-16 text-pale md:px-16 md:py-24">
            <div>
              ...
              <h1 className="mt-6 whitespace-pre-line font-display text-[28px] leading-[1.6] font-medium tracking-[0.04em] md:text-[36px]">
                {contactCopy.title}
              </h1>
            ...
            <div className="mt-14 flex flex-col gap-5 font-label text-xs tracking-[0.06em]">
