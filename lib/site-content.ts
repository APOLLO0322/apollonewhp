...
export const profileRows: Row[] = [
  {
    k: "経歴",
    v: "1987年3月7日 徳島県海部郡宍喰町生まれ、愛媛県松山市育ち。15歳より独学でダンスをはじめ、LOCK・HOUSE・BREAKINGを習得。19歳で大阪ダンス＆アクターズ専門学校の一期生として入学、21歳で東京ディズニーリゾートのダンサーに合格。26歳でJAZZダンスに転向、以後数々の舞台・コンサートに出演し、振付師としても活躍。2023年、愛媛へUターンし株式会社APOLLOを創業。地域と地方の発信力強化を命題とし活動する傍ら地域振興の一環として、20代を中心としたダンスグループ「Growth」を主宰。次世代を担う若者とエンタメを通したまちづくりを行う。",
  },
  {
    k: "舞台出演",
...
export const services: Service[] = [
  {
    ...
    menuItems: ["ブランディング", "集客", "広告", "採用", "イベント", "ドキュメンタリー", "スチール"],
  },
  {
    num: "02",
    name: "SNS運用支援",
  ...
  },
  {
    num: "03",
    name: "イベント企画・運営",
    desc: "集客の施策づくりから、リアルイベントの企画・運営まで。東京都内の学童施設では運営をサポートし、利用者数の増加につなげました。自ら主催してきた数だけ、人が集まり愛される理由を知っています。",
